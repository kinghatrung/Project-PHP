        ...
        <div class="main">
                ...
                <div class="search-box">
                    ...
                    <div class="user-icon-box">
                        ...
                        <ul class="user-subnav">
                            ...
                            <li><a href="index.php?task=pageregister">Đăng kí</a></li>
                        </ul>
                    </div>
            ...
            <div class="content">
                <div id="join" class="content-section">
                    ...
                    <h2 class="section-heading">Tham gia</h2>
                    <div class="bg-box">
                        <div class="bg-section"></div>
                        <div class="bg-text-box">
                            <h2 class="bg-text">Hãy trở thành khách hàng của dhome</h2>
                            <h3 class="bg-subtext">Sáng tạo theo cách của bạn</h3>
                            <p class="bg-text-section">Hãy chọn cho riêng mình những thiết kế đẹp nhất của DHOME</p>
                            <a href="index.php?task=pageregister" class="bg-button">Tham gia ngay</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="form" class="content-img">
                    ...
                    <div class="bg-box">
                        <div class="bg-text-box">
                            <h2 class="bg-text">Khám phá các mẫu decor của bạn</h2>
                            <h3 class="bg-subtext">Sáng tạo theo cách của bạn</h3>
                            <p class="bg-text-section">Mỗi mẫu decor nội thất của DHOME đều có những nét đẹp riêng do các nhà thiết kế của công ty DHOME thiết kế riêng cho bạn. Hãy tham gia để nhận được nhiều mẫu Decor hơn của chúng tôi</p>
                            <a href="index.php?task=pagelogin" class="bg-button">Khám phá ngay</a>
                        </div>
                        <div class="bg-section"></div>
                    </div>
                </div>
                        ...
                        <div class="contact-address">
                            ...
                            <div class="address-list">
                                <p>
                                    ...
                                    Địa chỉ: 65 Đường Hoàng Văn Thụ, Phan Đình Phùng, TP Thái Nguyên, Thái Nguyên.
                                </p>
                                <p>
                                    <i class="contact-icon ti-map-alt"></i>
            ...
            <div class="footer-content">
                    ...
                    <p class="content-text">@ 2012 bản quyền của Decor. Decor - <a href="index.php?task=pagehome">Thiết kế nội thất</a></p>
                </div>
            </div>
        </div>
    </body>
