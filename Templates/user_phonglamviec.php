...
<html lang="en">
    <head>
        ...
        <title>DHOME | Mẫu Phòng Làm Việc</title>
    </head>
        ...
        <div class="main">
            ...
            <div class="nav-logo">
                ...
                <!-- <form action="" class="search-form">
                    <div class="search-btn-box">
                        <button class="search-btn"><i class="search-icon ti-search"></i></button>
                    </div>
                ...
                <div class="search-box">
                    ...
                    <div class="user-icon-box">
                        <a class="user-icon-link"><i class="ti-user"></i></a>
            ...
            <div class="content">
                <div id="form" class="content-img">
                    <h2 class="section-heading-decor">Mẫu Decor Phòng Làm Việc</h2>
                    <div class="decor-list">
                        <?php 
                            require_once "Controllers/controller.php";
                            $controller = new controller();
                            $sp = isset($_GET['sp']) ? $_GET['sp'] : 'plv';
