...
<html lang="en">
    <head>
        ...
        <title>DHOME - Admin/Nhân Viên</title>
    </head>
    ...
    <body>
        <div class="main">
            <div class="header">
                ...
                <form action="index.php?task=pagepersonnel" method="POST" class="form-box">
                    <div class="btn-box"> 
                        <button name="snv" class="search-btn"><i class="ti-search"></i></button>
                    </div>
                    
                    <div class="input-box">
                        <input type="search" name="searchnv" class="input-search-box" placeholder="Tìm kiếm">
                    </div>
                </form>
                <div class="user-box">
                    <div class="line"></div>
            ...
            <div class="content">
                <h3 class="content-text">Trang Quản Lý Nhân Viên</h3>
                <div class="add-box">
                    <a class="add-user js-add">Thêm Nhân Viên</a>
                </div>
                        ...
                        <table class="content-table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    isset($_POST['snv']) ? $result = $controller -> searchPersonnel():$result = $controller -> getNV();
                                    $id = 1;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="td-setting js-delete"
                                                    href="index.php?task=pagepersonnel&manv=<?php echo $row['manv'] ?>">Xoá</a>
                                            </td>
                                        </tr>
                                    <?php }
                                ?>
        ...
        <div class="modal js-modal">
            <div class="modal-container js-modal-container">
                ...
                <div class="model-header">
                    <h3 class="header-text">Thêm Nhân Viên</h3>
                </div>
                ...
                <div class="modal-body">
                    <form action="" method="POST">
                        ...
                        <input name="manv" type="text" class="modal-input" placeholder="Điền Mã Nhân Viên" required="">

                        <label for="" class="modal-label">
                            Tên Nhân Viên
                        </label>
                        <input name="tennv" type="text" class="modal-input" placeholder="Điền Tên Nhân Viên" required="">

                        <label for="" class="modal-label">
                            Gmail
                        </label>
                        <input name="email" type="email" class="modal-input" placeholder="Điền Gmail" required="">

                        <label for="" class="modal-label">
                            Số Điện Thoại
                        </label>
                        <input name="phone" type="text" class="modal-input" placeholder="Điền Số Điện Thoại" required="">

                        <label for="" class="modal-label">
                            Quê Quán
                        </label>
                        <input name="address" type="text" class="modal-input" placeholder="Điền Quê Quán" required="">

                        <input name="addnv" type="submit" class="modal-add" value="Thêm Nhân Viên">
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="modal-fix js-modal-fix">
            <div class="modal-container js-modal-container-fix">
                ...
                <div class="modal-header">
                    <h3 class="header-text">Sửa Nhân Viên</h3>
                </div>
                ...
                <div class="modal-body">
                    <div class="box-fix">
                        <form action="" method="POST">
                            ...
                            <input name="manv" type="text" class="modal-input" placeholder="Sửa Mã Nhân Viên" required="">
    
                            <label for="" class="modal-label">
                                Tên Nhân Viên
                            </label>
                            <input name="tennv" type="text" class="modal-input" placeholder="Sửa Tên Nhân Viên" required="">
    
                            <label for="" class="modal-label">
                                Gmail
                            </label>
                            <input name="email" type="email" class="modal-input" placeholder="Sửa Gmail" required="">
    
                            <label for="" class="modal-label">
                                Số Điện Thoại
                            </label>
                            <input name="phone" type="text" class="modal-input" placeholder="Sửa Số Điện Thoại" required="">
    
                            <label for="" class="modal-label">
                                Quê Quán
                            </label>
                            <input name="address" type="text" class="modal-input" placeholder="Sửa Quê Quán" required="">
    
                            <input name="updatenv" type="submit" class="fix-input" value="Sửa Nhân Viên">
                        </form>
                    </div>
                </div>
            </div>
